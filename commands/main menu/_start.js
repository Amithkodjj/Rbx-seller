...
if (!User.getProperty("newUser")) {
  ...
  let userLink = "<a href='tg://user?id=" + user.telegramid + "'>" + user.first_name + "</a>"
...
var values = AdminPanel.getPanelValues("MembershipChecker");

var channels = values.Chats;
...
btns.push([{ text: "✅ I've Joined", callback_data: "/start" }])
